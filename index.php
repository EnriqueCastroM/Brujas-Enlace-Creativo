    ...
    <section class="py-5">
        <div class="container my-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h2>Bienvenido a Brujas Enlace Creativo</h2>
                    <!-- Content section-->
                    <section class="py-5">
                        <div class="container my-5">
                            <div class="row justify-content-center">
                                <div class="col-lg-6">
                                    <h2>Conectándo a nuestra comunidad</h2>
                                    <p class="lead">Brujas Enlace Creativo es una iniciativa que comenzó reconociendo la
                                        necesidad que
                                        tienen los trabajadores independientes, también conocidos como freelancers, para
                                        conseguir
                                        clientes que estén dispuestos a pagar el trabajo de manera justa, o clientes en
                                        general.
                                    </p>
                                    <p class="lead">
                                        El objetivo de Brujas EC, es conectar a freelancers y clientes para la búsqueda
                                        y entrega de un trabajo de calidad de manera personalizada.
                                    </p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="input1"
                                                aria-describedby="emailHelp" placeholder="Constraseña">
